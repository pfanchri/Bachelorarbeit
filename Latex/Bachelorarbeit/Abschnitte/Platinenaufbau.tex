...
\caption{Layout des Transceivers mit der Sollbruchstelle und der Steckerleiste (links) sowie dem Anpassnetzwerk. Die Lötflächen für die SMA-Buchse sind auf der rechten Seite erkennbar}
\label{fig:tdalayout}
\end{figure}
