% Header
\PassOptionsToPackage{printonlyused,withpage}{acronym} %damit acronym Seiten anzeigen kann(wird in documentclass geladen, doppeltes laden mit anderen Optionen ergibt fehler)
\documentclass[
	a4paper,
	%oneside,
	twoside,
...
%eigene Packete
\hyphenation{Trans-cei-ver Trans-cei-vern}		%korrigiert falsche Silbentrennungen
\usepackage{makeidx}
\makeindex
\usepackage{pdfpages}
%eigene Packete ende
...
%%%% Kopf- und Fußzeilen %%%%
	...
	%\cfoot{Stand: \today }   %zeigt aktuellen Stand an
