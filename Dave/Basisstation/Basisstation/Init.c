...
void init(void) {
	...
	XMC_GPIO_SetMode(PORT_P_ON_TDA_2, PIN_P_ON_TDA_2,
			XMC_GPIO_MODE_OUTPUT_PUSH_PULL);
	XMC_GPIO_SetMode(PORT_P_ON_TDA_3, PIN_P_ON_TDA_3,
			XMC_GPIO_MODE_OUTPUT_PUSH_PULL);
	XMC_GPIO_SetMode(PORT_P_ON_TDA_4, PIN_P_ON_TDA_4,
			XMC_GPIO_MODE_OUTPUT_PUSH_PULL);
	XMC_GPIO_SetMode(PORT_P_ON_TDA_5, PIN_P_ON_TDA_5,
			XMC_GPIO_MODE_OUTPUT_PUSH_PULL);
