...
void tda5340_init(void) {
	...
	tda5340_command(WRITE_TO_CHIP, A_PLLFRAC0C1, 0x63); //PLL Fractional Division Ratio Register 0 Channel 1
	...
	invalid += tda5340_command(WRITE_TO_CHIP, A_PLLFRAC0C1, 0xA5); /**< PLL fractional division ratio channel 1 */
	invalid += tda5340_command(WRITE_TO_CHIP, A_PLLFRAC1C1, 0xEE); /**< PLL fractional division ratio channel 1 */
